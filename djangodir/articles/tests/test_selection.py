...
class SelectionTest(TestCase):
    ...
    #     self.assertNotEqual(preference_after.good_noun_tfidf_pair, '')
    #     self.assertNotEqual(preference_after.uninterested_noun_tfidf_pair, '')
    ...
    #     self.assertEqual(preference_after.good_noun_tfidf_pair, '')
    #     self.assertEqual(preference_after.uninterested_noun_tfidf_pair, '')
